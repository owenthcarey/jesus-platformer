...
The Galilee background, six-pose Jesus movement sheet, hand-painted terrain, brambles, olive tree, historical landmark props, and Peter-and-Andrew character group were generated specifically for this project and processed locally for game use. Atmospheric effects, collectibles, checkpoints, shoreline details, and UI are rendered in Phaser.
